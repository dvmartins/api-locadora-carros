<template>
    <div class="container">
        ...
        <!-- inicio do modal de inclusão de marcars -->
        ...
        <!-- fim do modal de inclusão de maracas -->
        <!-- inicio do modal de vizualização de marcas -->
        ...
        <!-- fim do modal de vizualização de marcas -->
